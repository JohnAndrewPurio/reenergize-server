...
router.get("/", (request, response) => {
    ...
    CONTACT US
    For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at lyerdestroyer@gmail.com or by mail using the details provided below:
    
      Isabang, Lucena, PH-QUE, 4301, Philippines
    `);
});
