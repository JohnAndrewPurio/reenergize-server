...
router.get("/", async (request, response) => {
    ...
    try {
        const data = await (0, solcast_1.getWorldPvPowerEstimatedActuals)(latitude, longitude, capacity, tilt ? tilt : "", azimuth ? azimuth : "", install_date ? install_date : "", loss_factor ? loss_factor : "", hours ? hours : "");
        response.json(data);
    }
    catch (e) {
